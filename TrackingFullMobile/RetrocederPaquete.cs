...
{
    [Activity(Label = "AnularPaquete")]
    public class RetrocederPaquete : Activity, IPermissionListener
    {
        ...
        {
            private RetrocederPaquete escanear;

            public MyResultHandler(RetrocederPaquete escanear)
            {
            ...
            public string Retroceder(int id)
            {
                var client = new RestClient("https://apirest20191105064440.azurewebsites.net/api/Paquete/RetrocederEstado?id=" + id);
